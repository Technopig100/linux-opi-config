...
#define TSK_STACK_CANARY 1064 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2448 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 3536 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 3432 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3512 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 3528 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define TRAMP_VALIAS -4398084284416 /* TRAMP_VALIAS */
